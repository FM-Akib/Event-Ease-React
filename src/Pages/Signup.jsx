...
const Signup = () => {
  ...
  return (
    ...
    <div className="md:grid grid-cols-10 p-2 md:p-14 md:pt-2 ">




     <div className="  md:border-r-0 md:rounded-l-md col-span-5 bg-white">
            ...
            <div className="  md:rounded-r-md    col-span-5 bg-white p-10 flex flex-col items-center justify-start">
             <div className="">
