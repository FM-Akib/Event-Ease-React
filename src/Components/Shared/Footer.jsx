    ...
    return (
        ...
        <div className="md:px-12 lg:px-28">
          <div className="container m-auto space-y-6 text-gray-600 ">
            ...
            >
              <li role="listitem"><Link to="/" className="hover:text-primary">Home</Link></li>
              <li role="listitem"><Link to="/allhalls" className="hover:text-primary">Halls</Link></li>
              <li role="listitem"><Link to="/card" className="hover:text-primary">Invitation Card</Link></li>
              <li role="listitem"><Link to="/about" className="hover:text-primary">About us</Link></li>
            </ul>
            ...
            <div className="text-center">
              <span className="text-sm tracking-wide"
                >Copyright © EventEase <span id="year"></span> | All right reserved</span
              >
            </div>
          </div>
        </div>
