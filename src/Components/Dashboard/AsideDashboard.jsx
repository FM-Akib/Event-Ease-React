...
const AsideDashboard = () => {
    return (
      ...
      <li className="border-[1px] py-1 px-1 rounded-lg bg-white/80"><Link to="/dashboardHall/editProfile" className="flex items-center"><FaUserEdit  className="text-xl"/>Edit Profile</Link></li>
